...
namespace ElasticsearchLegacy\Tests\Helper\Iterators;

use ElasticsearchLegacy\Helper\Iterators\SearchResponseIterator;
use Mockery as m;

/**
 * Class SearchResponseIteratorTest
 * @package ElasticsearchLegacy\Tests\Helper\Iterators
...
class SearchResponseIteratorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testWithNoResults() {
        ...
        $mock_client = m::mock('\ElasticsearchLegacy\Client');
