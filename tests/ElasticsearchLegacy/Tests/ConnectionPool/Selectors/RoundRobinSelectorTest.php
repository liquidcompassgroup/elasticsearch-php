...
class RoundRobinSelectorTest extends \PHPUnit_Framework_TestCase
{
     ...
     *
     * @covers \ElasticsearchLegacy\ConnectionPool\Selectors\RoundRobinSelector::select
     *
     * @return void
     */
    public function testTenConnections()
    {
        ...
        foreach (range(0, 10) as $index) {
            $mockConnections[$index] = $this->getMockBuilder('\ElasticsearchLegacy\Connections\CurlMultiConnection')
