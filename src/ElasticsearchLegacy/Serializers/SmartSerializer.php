...
namespace ElasticsearchLegacy\Serializers;

use ElasticsearchLegacy\Common\Exceptions\Serializer\JsonErrorException;

/**
 * Class SmartSerializer
 *
 * @category Elasticsearch
 * @package  ElasticsearchLegacy\Serializers\JSONSerializer
