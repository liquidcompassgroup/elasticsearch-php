...
namespace ElasticsearchLegacy\Connections;

use ElasticsearchLegacy\Common\Exceptions\AlreadyExpiredException;
...
use ElasticsearchLegacy\Common\Exceptions\Curl\CouldNotResolveHostException;
use ElasticsearchLegacy\Common\Exceptions\Curl\OperationTimeoutException;
use ElasticsearchLegacy\Common\Exceptions\Forbidden403Exception;
use ElasticsearchLegacy\Common\Exceptions\MaxRetriesException;
use ElasticsearchLegacy\Common\Exceptions\Missing404Exception;
use ElasticsearchLegacy\Common\Exceptions\NoDocumentsToGetException;
use ElasticsearchLegacy\Common\Exceptions\NoShardAvailableException;
use ElasticsearchLegacy\Common\Exceptions\RequestTimeout408Exception;
use ElasticsearchLegacy\Common\Exceptions\RoutingMissingException;
use ElasticsearchLegacy\Common\Exceptions\ScriptLangNotSupportedException;
use ElasticsearchLegacy\Common\Exceptions\ServerErrorResponseException;
 ...
 * @package  ElasticsearchLegacy\Connections
...
class Connection implements ConnectionInterface
{
     ...
     * @param \ElasticsearchLegacy\Serializers\SerializerInterface $serializer
     ...
     * @param null $body
     * @param array $options
     * @param \ElasticsearchLegacy\Transport $transport
     * @return mixed
     */
     ...
     * @param $request
     * @param $response
     * @return \ElasticsearchLegacy\Common\Exceptions\Curl\CouldNotConnectToHost|\ElasticsearchLegacy\Common\Exceptions\Curl\CouldNotResolveHostException|\ElasticsearchLegacy\Common\Exceptions\Curl\OperationTimeoutException|\ElasticsearchLegacy\Common\Exceptions\MaxRetriesException
     */
     ...
     * @param $response
     * @param $ignore
     * @throws \ElasticsearchLegacy\Common\Exceptions\AlreadyExpiredException|\ElasticsearchLegacy\Common\Exceptions\BadRequest400Exception|\ElasticsearchLegacy\Common\Exceptions\Conflict409Exception|\ElasticsearchLegacy\Common\Exceptions\Forbidden403Exception|\ElasticsearchLegacy\Common\Exceptions\Missing404Exception|\ElasticsearchLegacy\Common\Exceptions\ScriptLangNotSupportedException|null
     */
     ...
     * @param $response
     * @param $ignore
     * @throws \ElasticsearchLegacy\Common\Exceptions\NoDocumentsToGetException|\ElasticsearchLegacy\Common\Exceptions\NoShardAvailableException|\ElasticsearchLegacy\Common\Exceptions\RoutingMissingException|\ElasticsearchLegacy\Common\Exceptions\ServerErrorResponseException
     */
    ...
    private function tryDeserialize400Error($response) {
        return $this->tryDeserializeError($response, 'ElasticsearchLegacy\Common\Exceptions\BadRequest400Exception');
    }

    private function tryDeserialize500Error($response) {
        return $this->tryDeserializeError($response, 'ElasticsearchLegacy\Common\Exceptions\ServerErrorResponseException');
    }
