 ...
 * @package  ElasticsearchLegacy\Namespaces\TaskNamespace
...
class TasksNamespace extends AbstractNamespace
{
    ...
    public function cancel($params = [])
    {
        ...
        /** @var \ElasticsearchLegacy\Endpoints\Tasks\Cancel $endpoint */
    ...
    public function show($params = [])
    {
        ...
        /** @var \ElasticsearchLegacy\Endpoints\Tasks\Get $endpoint */
