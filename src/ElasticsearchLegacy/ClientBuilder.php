...
use ElasticsearchLegacy\ConnectionPool\StaticNoPingConnectionPool;
use ElasticsearchLegacy\Connections\Connection;
use ElasticsearchLegacy\Connections\ConnectionFactory;
use ElasticsearchLegacy\Connections\ConnectionFactoryInterface;
use ElasticsearchLegacy\Serializers\SerializerInterface;
use ElasticsearchLegacy\ConnectionPool\Selectors;
use ElasticsearchLegacy\Serializers\SmartSerializer;
...
class ClientBuilder
{
    ...
    /** @var string */
    private $connectionPool = '\ElasticsearchLegacy\ConnectionPool\StaticNoPingConnectionPool';

    /** @var  string */
    private $serializer = '\ElasticsearchLegacy\Serializers\SmartSerializer';

    /** @var  string */
    private $selector = '\ElasticsearchLegacy\ConnectionPool\Selectors\RoundRobinSelector';
     ...
     * @return \ElasticsearchLegacy\Client
     */
    ...
    /**
     * @param \ElasticsearchLegacy\Connections\ConnectionFactoryInterface $connectionFactory
     * @return $this
     */
    ...
    /**
     * @param \ElasticsearchLegacy\ConnectionPool\AbstractConnectionPool|string $connectionPool
     * @param array $args
    ...
    /**
     * @param \ElasticsearchLegacy\Serializers\SerializerInterface|string $serializer
     * @throws \InvalidArgumentException
     * @return $this
     */
    ...
    /**
     * @param \ElasticsearchLegacy\ConnectionPool\Selectors\SelectorInterface|string $selector
     * @throws \InvalidArgumentException
     * @return $this
     */
    ...
    public function build()
    {
        ...
        if (is_null($this->endpoint)) {
            ...
            $this->endpoint = function ($class) use ($transport, $serializer) {
                $fullPath = '\\ElasticsearchLegacy\\Endpoints\\' . $class;
     ...
     *
     * @throws \InvalidArgumentException
     * @return \ElasticsearchLegacy\Connections\Connection[]
     */
