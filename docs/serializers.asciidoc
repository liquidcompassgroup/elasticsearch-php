...
$client = ClientBuilder::create()
            ->setSerializer('\ElasticsearchLegacy\Serializers\SmartSerializer');
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setSerializer('\ElasticsearchLegacy\Serializers\ArrayToJSONSerializer');
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setSerializer('\ElasticsearchLegacy\Serializers\EverythingToJSONSerializer');
            ->build();
----
