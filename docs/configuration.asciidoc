...
try {
    ...
    if ($previous instanceof 'ElasticsearchLegacy\Common\Exceptions\MaxRetriesException') {
        echo "Max retries!";
    }
}
----
...
[source,php]
----
$connectionPool = '\ElasticsearchLegacy\ConnectionPool\StaticNoPingConnectionPool';
$client = ClientBuilder::create()
...
[source,php]
----
$selector = '\ElasticsearchLegacy\ConnectionPool\Selectors\StickyRoundRobinSelector';
$client = ClientBuilder::create()
...
[source,php]
----
$serializer = '\ElasticsearchLegacy\Serializers\SmartSerializer';
$client = ClientBuilder::create()
