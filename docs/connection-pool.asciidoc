...
$client = ClientBuilder::create()
            ->setConnectionPool('\ElasticsearchLegacy\ConnectionPool\StaticNoPingConnectionPool', [])
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setConnectionPool('\ElasticsearchLegacy\ConnectionPool\SimpleConnectionPool', [])
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setConnectionPool('\ElasticsearchLegacy\ConnectionPool\SniffingConnectionPool', [])
            ->build();
----
