...
$client = ClientBuilder::create()
            ->setSelector('\ElasticsearchLegacy\ConnectionPool\Selectors\RoundRobinSelector')
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setSelector('\ElasticsearchLegacy\ConnectionPool\Selectors\StickyRoundRobinSelector')
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setSelector('\ElasticsearchLegacy\ConnectionPool\Selectors\RandomSelector')
            ->build();
----
